# -*- coding: utf-8 -*-
"""Copy of Copy of C-132 Solution.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Q33gZcxvUpICAtHBsc-a7ig8tQgj0Sr4
...
"""Astronomconomical Unit(AU) which is roughly the distance between Sun and Earth.
1AU=1.496e+8
"""
...
"""Goldilocks Zone-where there might be life .Right condition
Earth is 1AU from the Sun
Mars is 1.5 AU from the Sun
planets which lie between 0.38-2AU ,are suitable for life.
"""
...
"""Earth travels at a speed of 30km per second.

Circumference of circle=2piR

Complete solar system revolved around the centre of milky way galaxy at the speed of 200km per second.
...
All these planets come in goldilocks zone

Speed of these planets
Mercury-47km/s
Venus-35km/s
Earth-30km/s
Mars-24km/s

WITH RESPECT TO THE SPEED,ALL ARE HABITABLE PLANETS

Mercury:
Not habitable since it does not have an atmosphere & the temperature varies from 100 degree C to 700 degree C.

Venus:
Not habitable- Hottest planet and its atmosphere traps the heat on the surface and the temperature is almost 700 degree C
There is sulphuric acid rain

Earth':
Right planet to live

Mars:
Some atmosphere is present along with water on its surface
Temperature lies between 20 degree to 150 degree C

Tidally locked planet:
One side is extremely hot and one side extremely cold.

5 lists that contain all the data
1)Planets that support only gravity
2)Planets that support both gravity and are suitable
3)Planets that support all gravity,suitable and fall in goldilocks zone
4)Planets that support gravity,suitabel type with suitable speed.
5)Planets that are potentially habitable that support all the above data.
"""
